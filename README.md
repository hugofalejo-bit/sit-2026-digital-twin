...
Crea y activa un entorno virtual de Python (se recomienda .venv).

Instala las dependencias requeridas ejecutando pip install -r requirements.txt en la terminal.

Asegúrate de contar con el archivo de base de datos Parquet estructurado en la ruta data/processed/ o, en su defecto, configura tu token de MotherDuck localmente dentro del directorio oculto .streamlit/secrets.toml.

Inicia el servidor de desarrollo ejecutando streamlit run app.py.
